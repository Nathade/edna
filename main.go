...
func main() {
	...
	router.Post("/api/changepassword", commonHandlers.Append(dbsetter, config.frontAuthHandler).ThenFunc(config.updateUserPasswordHandler))
	...
	router.Get("/api/getclassdata", commonHandlers.Append(dbsetter, config.frontAuthHandler).ThenFunc(config.getClassDataHandler))
	...
	router.Post("/api/deleteassessment", commonHandlers.Append(dbsetter, config.frontAuthHandler).ThenFunc(config.deleteAssessmentHandler))
